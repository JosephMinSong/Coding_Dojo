...
function isPresent2d(arr2d, value){
    for (var i = 0; i < arr2d.length; i++){
        for (var i2 = 0; i < arr2d[i].length; i++){
            if (arr2d[i][i2] === value){
                return true;
            }
        }
...
return a new array containing just the values from inside the sub-arrays. Don't assume the array will always be the same size, 
