...
function kMostFrequent(numbers, k) {
    ...
    for (let i = 0; i < numbers.length; i++){
        if (numbersHash.hasOwnProperty(numbers[i])){
            numbersHash[numbers[i]] ++
        } else {
            numbersHash[numbers[i]] = 1
        }
...
console.log(kMostFrequent(numbers1, 2))
console.log(kMostFrequent(numbers2, 1))
console.log(kMostFrequent(numbers3, 3))