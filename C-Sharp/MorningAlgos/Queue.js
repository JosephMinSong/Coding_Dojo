...
class Queue {
   ...
   */
    compareQueues(q2){
        ...
        while(i < this.size()){
            const dequeuedItemQ1 = this.dequeue();
            const dequeuedItemQ2 = q2.dequeue();

            if(dequeuedItemQ1 != dequeuedItemQ2){
                same = false;
            }

            this.enqueue(dequeuedItemQ1);
            q2.enqueue(dequeuedItemQ2);
            i++
        }
        return same
    }
...
firstQueue.enqueue(1).enqueue(2).enqueue(3).enqueue(4).enqueue(5)
secondQueue.enqueue(1).enqueue(2).enqueue(3).enqueue(4).enqueue(5)
palindromeQueue.enqueue(1).enqueue(2).enqueue(2).enqueue(1)


console.log(palindromeQueue.isPalindrome());
palindromeQueue.print();